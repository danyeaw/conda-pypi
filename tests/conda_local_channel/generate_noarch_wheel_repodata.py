...
def pypi_to_repodata_whl_entry(
    ...
    """
    # Find a pure Python wheel (platform tag "none-any"), matching conda-pypi behavior.
    wheel_url = None
...
if __name__ == "__main__":
    ...
    pkg_whls: dict[str, dict[str, Any]] = {}
    repodata_packages: list[tuple[str, str]] = []
    ...
    with open(requested_wheel_packages_file) as f:
        for line in f:
            ...
            repodata_packages.append((name.strip(), version.strip()))
    ...
    with ThreadPoolExecutor(max_workers=25) as executor:
        ...
        for future in as_completed(futures):
            ...
            try:
                ...
                if result:
                    key = f"{result['name']}-{version}-py3_none_any_0"
                    pkg_whls[key] = result
